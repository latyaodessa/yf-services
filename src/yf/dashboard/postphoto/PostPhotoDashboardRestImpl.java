...
public class PostPhotoDashboardRestImpl {
    ...
    public Response savePostForUser(@PathParam("publication_id") final Long publicationId,
                                    final UserVerificationDto dto) {
        ...
        final PostDashboardElasticDTO postDashboardElasticDTO = postPhotoDashboardService.saveNewPublicationForUser(publicationId,
                dto.getUserId());

        return Response.ok()
                .entity(postDashboardElasticDTO)
                .build();
    }
    ...
    public PostDashboardElasticDTO isPublicationEmptyByUser(@PathParam("user_id") final Long user_id,
        ...
        return postPhotoDashboardService.getSavedPublication(user_id,
                pubId);
    }
    // TODO
    // @POST
    ...
    public List<PostDashboardElasticDTO> getSavedDashboardPosts(@PathParam("user_id") String user_id,
        ...
        return postPhotoDashboardService.getSavedDashboardPosts(user_id,
                from,
                size);
    }
    ...
    public List<PhotoDashboardElasticDTO> getSavedDashboardPhotos(@PathParam("user_id") String user_id,
                                                                  @PathParam("from") int from,
                                                                  @PathParam("size") int size) {
        return postPhotoDashboardService.getSavedDashboardPhotos(user_id,
                from,
                size);
    }
    ...
    public Response deletePostFromUser(@PathParam("savedPubId") final Long savedPubId,
                                       final UserVerificationDto dto) {
