...
@NamedQueries({@NamedQuery(name = UserSavedPhotos.QUERY_FIND_SAVED_PHOTO_AND_BY_USER_ID,
                           query = "SELECT t FROM UserSavedPhotos t where t.user_id = :user_id and t.photo_url = :photo_url") })
public class UserSavedPhotos {
    ...
    public UserSavedPhotos(Long id,
                           String photo_url,
                           long user_id,
                           Date date,
                           String note,
