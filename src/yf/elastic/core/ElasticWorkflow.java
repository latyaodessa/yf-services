...
public class ElasticWorkflow {
    ...
    public boolean isIndexExist(final IndicesAdminClient adminClinet,
                                final String index) {
        return adminClinet.prepareExists(index)
                .execute()
                .actionGet()
                .isExists();
    }
