...
public class PublicationBulkWorkflow extends AbstractBulkReindexWorkflow<Publication, PublicationElasticDTO> {
    ...
    public void recreateIndex() {
        ...
        nativeElasticClient.getClient()
                .admin()
                .indices()
                .prepareCreate(properties.get("elastic.index.publication"))
                .setSettings(getAnalyzer())
                .addMapping(properties.get("elastic.type.photo"),
                        createTypeMapping())
                .execute()
                .actionGet();
    ...
    @Override
    public void execute(final List<Publication> entities) {
        ...
        if (bulkResponse.hasFailures()) {
            LOGGER.log(Level.SEVERE,
                    "BULK REINDEX FAILURE");
        }
    }

    @Override
    public void addEntityToBulk(final PublicationElasticDTO dto,
                                final BulkRequestBuilder bulkRequest,
                                final BulkOptions bulkOption)
