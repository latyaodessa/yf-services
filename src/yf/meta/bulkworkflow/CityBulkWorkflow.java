...
public class CityBulkWorkflow extends AbstractBulkReindexWorkflow<City, CityDTO> {
    ...
    public void recreateIndex() {
        ...
        nativeElasticClient.getClient().admin().indices().prepareCreate(properties.get("elastic.index.city"))
    ...
    @Override
    public void addEntityToBulk(CityDTO dto, BulkRequestBuilder bulkRequest, BulkOptions bulkOption) throws JsonProcessingException {
